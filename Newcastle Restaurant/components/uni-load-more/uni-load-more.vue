...
<script>
	...
	/**
	 * LoadMore Load More
	 * @description Used in lists to do scrolling loading, showing the various states of loading
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=29
	 * @property {String} status = [more|loading|noMore] Status of loading
	 * 	@value more Before loading
	 * 	@value loading loading
	 * 	@value noMore No more
	 * @property {Number} iconSize Specify icon size
	 * @property {Boolean} iconSize = [true|false] 是否显示 loading Icons
	 * @property {String} iconType = [snow|circle|auto] Specify icon style
	 * 	@value snow iosSnowflake loading style
	 * 	@value circle Android wake-up loading style
	 * 	@value auto Automatic selection of loading styles based on platform
	 * @property {String} color Icon and text color
	 * @property {Object} contentText Text description of each status, with values: {contentdown: "Pull up to show more",contentrefresh: "Loading..." ,contentnomore: "No more data" }
	 * @event {Function} clickLoadMore Triggered when clicking to load more
	 */
	export default {
		name: 'UniLoadMore',
		props: {
			status: {
				// The state of the pull-up：more-before-loading；loading-loading；noMore-No more
				type: String,
				default: 'more'
			},
			showIcon: {
			...
			contentText: {
				...
				default () {
					return {
						...
						contentnomore: 'No more data available'
					}
				}
			}
		},
